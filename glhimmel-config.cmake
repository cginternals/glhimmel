...
set(GLHIMMEL_INCLUDES "")
set(GLHIMMEL_LIBRARIES "")
...
macro (find LIB_NAME HEADER)
    ...
    if (${LIB_NAME} STREQUAL "glhimmel")
        set(LIB_NAME_UPPER GLHIMMEL)
        set(LIBNAME glhimmel)
    else()
        string(TOUPPER GLHIMMEL_${LIB_NAME} LIB_NAME_UPPER)
	...
	${HEADER}
        ${ENV_GLHIMMEL_DIR}/include
        ${ENV_GLHIMMEL_DIR}/source/${LIB_NAME}/include
        ${GLHIMMEL_DIR}/include
        ${GLHIMMEL_DIR}/source/${LIB_NAME}/include
        ${ENV_PROGRAMFILES}/glhimmel/include
        /usr/include
        /usr/local/include
        /sw/include
        /opt/local/include
    ...
    list(APPEND GLHIMMEL_INCLUDES ${${LIB_NAME_UPPER}_INCLUDE_DIR})
    list(APPEND GLHIMMEL_LIBRARIES ${${LIB_NAME_UPPER}_LIBRARY})
...
if(CMAKE_CURRENT_LIST_FILE)
    get_filename_component(GLHIMMEL_DIR ${CMAKE_CURRENT_LIST_FILE} PATH)
endif()

file(TO_CMAKE_PATH "$ENV{PROGRAMFILES}" ENV_PROGRAMFILES)
file(TO_CMAKE_PATH "$ENV{GLHIMMEL_DIR}" ENV_GLHIMMEL_DIR)

set(LIB_PATHS
    ${GLHIMMEL_DIR}/build
    ${GLHIMMEL_DIR}/build/Release
    ${GLHIMMEL_DIR}/build/Debug
    ${GLHIMMEL_DIR}/build-release
    ${GLHIMMEL_DIR}/build-debug
    ${GLHIMMEL_DIR}/lib
    ${ENV_GLHIMMEL_DIR}/lib
    ${ENV_PROGRAMFILES}/glhimmel/lib
    /usr/lib
    /usr/local/lib
    /sw/lib
    /opt/local/lib
...
find_package_handle_standard_args(GLHIMMEL DEFAULT_MSG GLHIMMEL_LIBRARIES GLHIMMEL_INCLUDES)
mark_as_advanced(GLHIMMEL_FOUND)
